...
class TareasController extends BaseController
{
    ...
    public function store()
    {
        ...
        if (empty($data['titulo']) || empty($data['descripcion']) || empty($data['fecha_entrega'])) {
            ...
            // Devolvemos un status 400 (Bad Request) y un mensaje de error
        ...
        try {
            ...
            if ($result === false) {
                ...
                // Devolvemos un status 500 (Internal Server Error) y un mensaje de error
            ...
            // Devolvemos un status 200 (OK) y un mensaje de éxito
           
            return redirect()->to(base_url('/dashboard'))->with('success', 'Tarea creada correctamente')->setStatusCode(200);
        } catch (\Exception $e) {
