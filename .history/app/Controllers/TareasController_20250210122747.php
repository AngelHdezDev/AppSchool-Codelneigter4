...
class TareasController extends BaseController
{
    ...
    public function store()
    {
        ...
        if (empty($data['titulo']) || empty($data['descripcion']) || empty($data['fecha_entrega'])) {
            ...
            // Redirigimos con mensaje de error si faltan datos
        ...
        try {
            ...
            if ($result === false) {
                ...
                // Redirigimos con mensaje de error si no se pudo insertar
            ...
            // Redirigimos con mensaje de error si ocurre una excepción
            return redirect()->to(base_url('dashboard'))->with('error', 'Hubo un error al crear la tarea');
        }
    }
}
